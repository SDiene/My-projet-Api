...
// Returns the private 'App\Repository\EnvoieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnvoieRepository.php';

return $this->privates['App\\Repository\\EnvoieRepository'] = new \App\Repository\EnvoieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
