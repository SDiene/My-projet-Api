...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/envoie' => [[['_route' => 'apiadd_transaction', '_controller' => 'App\\Controller\\TransactionController::addTransaction'], null, ['POST' => 0, 'GET' => 1], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        272 => [[['_route' => 'apishow_user', '_controller' => 'App\\Controller\\UserController::list'], ['id'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
