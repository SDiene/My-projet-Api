 ...
 */
final class Version20190812114001 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, compte_id INT NOT NULL, datetransaction DATETIME NOT NULL, envoie INT NOT NULL, retrait INT NOT NULL, INDEX IDX_723705D1A76ED395 (user_id), INDEX IDX_723705D1F2C56620 (compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
